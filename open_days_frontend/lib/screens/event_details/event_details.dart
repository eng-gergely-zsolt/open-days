...
class EventDetails extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    eventDetailsController.setQrImageText(_event?.id.toString() as String);
      ...
      body: isLoading == true
          ...
          : _event == null
              ...
              : initialData.when(
                  ...
                  data: (initialData) {
                    return buildPage(context, initialData, eventDetailsController);
                  },
                ),
    );
  }

  Widget buildPage(BuildContext context, IsUserAppliedForEvent initialData,
                    ...
                    onPressed: () {
                      showModalBottomSheet(
                          ...
                          builder: (BuildContext context) {
                            return buildModalBottomSheet(context, eventDetailsController);
                          });
                    },
                  ),
                )
