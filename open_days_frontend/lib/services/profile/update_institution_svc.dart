...
Future<BaseResponse> updateInstitutionSvc(String county, String institution) async {
  BaseResponse response = BaseResponse();
  final userId = await SecureStorage.getUserId() ?? '';
  final authorizationToken = await SecureStorage.getAuthorizationToken();
  const uri = 'https://open-days-thesis.herokuapp.com/open-days/user/update-institution';
